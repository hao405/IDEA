d = {
    "ETTh1": {
        "96": "python run_nsts.py --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --data ETTh1   --features M     --enc_in 7   --dec_in 7   --c_out 7"
              "  --seq_len 96 --label_len 0  --pred_len  96  --model NSTS  --zd_dim 3  --hidden_dim 384  --hidden_layers 2   --dropout 0   --activation relu   --learning_rate 0.001  --is_bn --zd_kl_weight 0.0001 --zc_kl_weight 0.0001  --hmm_weight 0.0001 ",
